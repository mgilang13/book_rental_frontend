...
import { getAllBookReturn, returnBookProcess } from "../../Redux/actions/book";
...
class BookHistory extends React.Component {
  ...
  getDataBookReturn = async () => {
    ...
    console.log("librarrrry: ", this.props.book.book.bookData.data);
    this.setState({
...
export default withRouter(connect(mapStateToProps)(BookHistory));
